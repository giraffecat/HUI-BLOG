<template>
  <el-card class="main-card">
    ...
    >
      ...
      <!-- 文章标题 -->
      <el-table-column prop="article_title" label="标题" align="center" />
      <!-- 文章分类 -->
      <el-table-column
        prop="category_name"
        label="分类"
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.views_count">
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.like_count">
...
export default {
  ...
  methods: {
    ...
    updateArticleDelete(id) {
      console.log("updateArticleDelte", id)
      let param = {};
      if (id != null) {
        param.idList = [id];
      } else {
      ...
      console.log("send request", param)
      this.axios.put("/admin/articles/delete", param).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: "成功",
    ...
    deleteArticles(id) {
      ...
      this.axios.delete("/admin/articles", param).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: "成功",
            message: data.message
